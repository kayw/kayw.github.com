    ...
    <>
      <div>
        <div className="pb-6 pt-6">
          <h1 className="sm:hidden text-3xl font-extrabold leading-9 tracking-tight text-gray-600 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
            {title}
          </h1>
        </div>
        <div className="flex sm:space-x-24">
          <div className="hidden max-h-screen h-full sm:flex flex-wrap bg-amber-50/50 dark:bg-zinc-800/50 shadow-lg transition-colors duration-200 pt-5 rounded min-w-[280px] max-w-[280px]">
              ...
              {displayPosts.map((post) => {
                ...
                return (
                  <li key={path} className="py-5 sm:-ml-6">
                    <article className="space-y-2 flex flex-col xl:space-y-0 hover:bg-zinc-50/50 hover:dark:bg-zinc-800/90 p-2 rounded-lg">
                      <dl>
