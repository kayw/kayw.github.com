...
/*
 * #TODO
 * https://nerdyarticles.com/a-clutter-free-life-with-paperless-ngx/ sidebar table of contents
 */
...
const TOCInline = ({
  ...
  return (
    <div>
      {asDisclosure ? (
        <details open className="bg-orange-50/60 dark:bg-zinc-800/95 rounded-lg py-2">
