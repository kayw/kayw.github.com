...
const Header = () => {
  ...
  return (
    <div className="mt-3">
      <header className="flex items-center justify-between shadow-md p-2 md:p-4 mb-8 bg-zinc-100/40 dark:bg-zinc-700/40 rounded-lg transition-colors duration-100">
        <div>
